...
yum install -y git automake gcc-c++ libtool make openssl-devel boost-devel libdb4-cxx-devel miniupnpc-devel libdb4-utils libevent-devel libdb4 libsecp256k1 zeromq libzmq3-devel qrencode protobuf
